...
## 1. Software Code
The source code may be used or modified for personal use without altering the original code in the repository.
Any attempts to modify the website and/or raid or destroy it is gonna land a ban from all services (streaming, discord server, discord bots, etc.) for long periods of time - if not forever.

## 2. Media Assets (Images, Videos, and Audio)
All media assets, including but not limited to images (.jpg, .png, .svg, .webp, etc.), videos (.mp4, .mov, etc.), and audio files (.mp3, .wav, etc.) uploaded to the repository are the exclusive property of the author and its creator(s).
...
## 3. Take-down Requests and Contact
If you are the owner or a contributor of any media asset found in this repository and wish to request its removal or modification, please use one of the following methods:
- **Direct Contact:** All contacts will be given on the website, or you can use the following:
  - Discord: furzonefox#0000 or furzonefox
  - Gmail: furzonefox@gmail.com
